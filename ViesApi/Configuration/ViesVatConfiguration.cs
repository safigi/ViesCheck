...
{
    public static readonly Dictionary<string, CountryVatFormat> Formats = new()
    {
        {
            "AT", new CountryVatFormat
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Austria" }, { "hu", "Ausztria" }, { "de", "Österreich" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Belgium" }, { "hu", "Belgium" }, { "fr", "Belgique" }, { "nl", "België" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Bulgaria" }, { "hu", "Bulgária" }, { "bg", "България" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Croatia" }, { "hu", "Horvátország" }, { "hr", "Hrvatska" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Czech Republic" }, { "hu", "Csehország" }, { "cs", "Česká republika" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Denmark" }, { "hu", "Dánia" }, { "da", "Danmark" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Estonia" }, { "hu", "Észtország" }, { "et", "Eesti" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Finland" }, { "hu", "Finnország" }, { "fi", "Suomi" }, { "sv", "Finland" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "France" }, { "hu", "Franciaország" }, { "fr", "France" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Germany" }, { "hu", "Németország" }, { "de", "Deutschland" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Greece" }, { "hu", "Görögország" }, { "el", "Ελλάδα" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Ireland" }, { "hu", "Írország" }, { "ga", "Éire" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Italy" }, { "hu", "Olaszország" }, { "it", "Italia" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Latvia" }, { "hu", "Lettország" }, { "lv", "Latvija" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Lithuania" }, { "hu", "Litvánia" }, { "lt", "Lietuva" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Luxembourg" }, { "hu", "Luxemburg" }, { "fr", "Luxembourg" }, { "de", "Luxemburg" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Netherlands" }, { "hu", "Hollandia" }, { "nl", "Nederland" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Poland" }, { "hu", "Lengyelország" }, { "pl", "Polska" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Portugal" }, { "hu", "Portugália" }, { "pt", "Portugal" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Romania" }, { "hu", "Románia" }, { "ro", "România" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Slovakia" }, { "hu", "Szlovákia" }, { "sk", "Slovensko" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Slovenia" }, { "hu", "Szlovénia" }, { "sl", "Slovenija" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Spain" }, { "hu", "Spanyolország" }, { "es", "España" } },
        ...
        },
        {
            ...
            {
                CountryNames = new Dictionary<string, string>
                    { { "en", "Sweden" }, { "hu", "Svédország" }, { "sv", "Sverige" } },
    ...
    public static List<string> GetSupportedLanguages()
    {
        ...
        foreach (var lang in Formats.Values.SelectMany(format => format.CountryNames.Keys))
        {
            languages.Add(lang);
        }
...
public class CountryVatFormat
{
    ...
    public string CountryName => GetCountryName();
    ...
    {
        if (CountryNames.TryGetValue(languageCode.ToLower(), out var name))
            return name;

        // Fallback to English if available
        if (CountryNames.TryGetValue("en", out var englishName))
            return englishName;
